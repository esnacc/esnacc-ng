...
/*
int TblEncodePrimTagsAndLens PROTO ((TBLType *tblT, GenBuf *b, int implicit, unsigned long *bytesEncoded));

int TblEncodeConsTagsAndLens PROTO ((TBLType *tblT, GenBuf *b, int implicit, unsigned long *bytesEncoded));
*/

int TblEncodeTagsAndLens PROTO ((TBLType *tblT, GenBuf *b, int implicit, unsigned long *bytesEncoded));

AsnLen TblEncTag PROTO ((GenBuf *b, TBLTag *tag));
    ...
    unsigned long *bytesEncoded)
{
    ...
    AsnList *lVal;
    int retVal = 0;
    unsigned long tmpBytesEncoded = 0;
