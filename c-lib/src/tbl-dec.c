...
void TblPopTagsAndLens PROTO ((TBLType *tblT, GenBuf *b, int implicit, unsigned long *bytesDecoded, ENV_TYPE env));

void TblDecodeTagsAndLens PROTO ((TBLType *tblT, GenBuf *b, int implicit, ENV_TYPE env));
...
{
    AVal *elmtVPtr;
    unsigned long tmpBytesDecoded = 0;
