 ...
 *
 * $Header: /baseline/SNACC/c-lib/inc/tbl-enc.h,v 1.5 2003/12/17 19:05:03 gronej Exp $
 * $Log: tbl-enc.h,v $
...
int TblEncode PROTO ((TBL *tbl, char *modName, char *typeName, GenBuf *b, AVal *v, unsigned long *bytesEncoded));

int TblEncodeType PROTO ((TBLType *tblT, GenBuf *b, AVal *v, int implicit, unsigned long *bytesEncoded));
