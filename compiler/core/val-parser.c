 ...
 *
 * $Header: /baseline/SNACC/compiler/core/val-parser.c,v 1.10 2004/04/06 15:13:41 gronej Exp $
 * $Log: val-parser.c,v $
    ...
    char *eof)
{
    ...
    switch (dT->basicType->choiceId)
    {
        ...
        case BASICTYPE_MACROTYPE:
			...
			{
				parseValuesErrG = 1;
				PrintErrLoc (m->asn1SrcFileName, valLineNoG);
			}
            break;
